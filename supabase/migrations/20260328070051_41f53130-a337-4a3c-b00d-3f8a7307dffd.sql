...
UPDATE public.eiere SET telefon = '41378024' WHERE navn = 'David Lange-Nielsen';
UPDATE public.eiere SET epost = 'sebastian@motivus.no', telefon = '92642074' WHERE navn = 'Sebastian Flåterud';
...
BEGIN
  ...
  INSERT INTO public.eiere (user_id, navn, type, eierandel_prosent, inntektsandel_prosent, kostnadsandel_prosent, identifikator, sist_endret, epost, telefon) VALUES
    (p_user_id, 'Sebastian Flåterud', 'privatperson', 42.63, 46.70, 42.63, '02027545583', '2025-03-07', 'sebastian@motivus.no', '92642074'),
    (p_user_id, 'Levi Flåterud', 'privatperson', 4.07, 0, 4.07, '16088344158', '2025-03-07', NULL, NULL),
    (p_user_id, 'David Lange-Nielsen', 'privatperson', 32.70, 32.70, 32.70, '13099829790', '2025-03-07', NULL, '41378024'),
    (p_user_id, 'Motivus AS', 'aksjeselskap', 20.60, 20.60, 20.60, '990144834', '2025-03-07', NULL, NULL);
